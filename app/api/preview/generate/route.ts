...
function buildRetailTemplate(data: TemplateData): string {
  ...
  const heroSection = `
  <section style="position:relative;min-height:calc(100vh - 132px);display:grid;grid-template-columns:1fr 1fr;background:${bg}">
...
<section class="hw-hero-section" style="min-height:calc(100vh - 112px);display:grid;grid-template-columns:1fr 1fr;background:${hw.bg};position:relative">
...
${buildStandardNav(businessName, content, navFlags)}
  ...
  <section style="position:relative;min-height:calc(100vh - 134px);display:flex;align-items:center;overflow:hidden;background:${bg};z-index:1">
...
function buildCreativeTemplate(data: TemplateData): string {
  ...
  const heroSection = `
  <section style="background:${ink};min-height:calc(100vh - 122px);display:grid;grid-template-columns:1fr 1fr;overflow:hidden" class="ms-grid">
