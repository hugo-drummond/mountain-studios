...
function buildRetailTemplate(data: TemplateData): string {
  ...
  const heroSection = `
  <section style="position:relative;height:100vh;display:flex;flex-direction:column;background:${bg}">
  ...
  <div style="background:${accent};padding:1.5rem 0;overflow:hidden;white-space:nowrap;flex-shrink:0">
    <div style="display:inline-flex;animation:marquee 25s linear infinite;gap:3rem">
      ${[...Array(8)].map(() => `<span style="font-family:var(--heading-font);font-size:1.3rem;font-weight:900;color:#fff;text-transform:uppercase;letter-spacing:0.08em">${content.heroEyebrow} &nbsp;&#10022;&nbsp; ${businessName} &nbsp;&#10022;&nbsp; ${content.ctaPrimary}</span>`).join('')}
    </div>
  </div>
...
<section class="hw-hero-section" style="height:100vh;display:flex;flex-direction:column;background:${hw.bg};position:relative">
<div style="flex:1;display:grid;grid-template-columns:1fr 1fr;min-height:0">
...
<div style="background:${hw.accent};padding:0.9rem 0;overflow:hidden;white-space:nowrap;flex-shrink:0">
...
${buildStandardNav(businessName, content, navFlags)}
  ...
  <section style="position:relative;height:100vh;display:flex;flex-direction:column;background:${bg};z-index:1">
...
function buildCreativeTemplate(data: TemplateData): string {
  ...
  const heroSection = `
  <section style="background:${ink};height:100vh;display:flex;flex-direction:column;position:relative">
