...
function buildRetailTemplate(data: TemplateData): string {
  ...
  const heroSection = `
  <section style="position:relative;flex:1;display:grid;grid-template-columns:1fr 1fr;background:${bg}">
...
<div style="min-height:100vh;display:flex;flex-direction:column">
<section class="hw-hero-section" style="flex:1;display:grid;grid-template-columns:1fr 1fr;background:${hw.bg};position:relative">
...
${buildStandardNav(businessName, content, navFlags)}
  ...
  <div style="min-height:100vh;display:flex;flex-direction:column">
  <section style="position:relative;flex:1;display:flex;align-items:center;overflow:hidden;background:${bg};z-index:1">
...
function buildCreativeTemplate(data: TemplateData): string {
  ...
  const heroSection = `
  <section style="background:${ink};flex:1;display:grid;grid-template-columns:1fr 1fr;overflow:hidden" class="ms-grid">
