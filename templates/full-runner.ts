...
const mockDataByCategory: Record<string, MockDef> = {
  ...
  retail:          { name: 'Maison Veld',        cat: 'retail',              color: '#1a2d4a', eyebrow: 'CAPE TOWN BOUTIQUE',  tagline: 'Curated style,<br/><em>every season</em>',              sub: 'Handpicked fashion and lifestyle pieces for quality-lovers.', cta: 'Shop Now',            img: '1441984904996-e0b6ba687e04' },
