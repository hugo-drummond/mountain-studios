...
function buildFoodHospitalityTemplate(data: TemplateData): string {
  ...
  <section id="gallery" style="padding:0;background:${bg}">
    <div style="max-width:1400px;margin:0 auto">
      <div class="food-gal-top" style="display:grid;grid-template-columns:1.4fr 1fr;gap:3px">
      ...
      <div class="food-gal-bot" style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:3px;margin-top:3px">
        ${[9,10,11].map(i => `
...
function buildProfessionalTemplate(data: TemplateData): string {
  ...
  <style>
    ...
    @media(max-width:768px){.pro-svc-img{display:none!important}}
  </style>
  ...
  <section id="services" style="padding:120px 0;background:${bg}">
    <div style="max-width:1240px;margin:0 auto;padding:0 2.5rem">
      ...
      <div class="ms-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:6rem;align-items:start">
        ...
        <!-- Sticky image panel -->
        <div class="ms-sticky pro-svc-img" style="position:sticky;top:120px;aspect-ratio:4/5;overflow:hidden;border:1px solid ${borderCol}">
          ${content.services.map((s, i) => `
