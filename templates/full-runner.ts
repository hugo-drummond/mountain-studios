...
<style>
  ...
  @media(max-width:768px){.vs-hero-eyebrow{display:none!important}.vs-svc-right{padding-top:0.5rem!important}.vs-hero-inner{padding:clamp(4rem,10svh,7rem) 1.25rem clamp(5rem,12svh,8rem)!important}}
</style>
