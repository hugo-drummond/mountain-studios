...
<style>
  ...
  @media(max-width:768px){.vs-hero-eyebrow{display:none!important}.vs-svc-right{padding-top:0.5rem!important}.vs-hero-inner{padding:clamp(4rem,10svh,7rem) 1.25rem clamp(5rem,12svh,8rem)!important}.vs-hero-stats>div{flex:1!important;text-align:center!important;border-left:none!important}.vs-hero-stats>div+div{border-left:1px solid rgba(255,255,255,0.08)!important}.vs-hero-stats>div:nth-child(n+4){display:none!important}}
</style>
...
function buildFoodHospitalityTemplate(data: TemplateData): string {
  ...
  <style>
    ...
    @media(max-width:768px){ #food-nav { padding:1rem 1.25rem; background:${inkDark} !important; } #food-nav > div > a:not(.food-nav-cta) { display:none!important; } #food-nav label { display:block!important; } }
  </style>
  <script>
