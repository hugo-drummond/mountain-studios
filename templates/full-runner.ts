...
const mockDataByCategory: Record<string, MockDef> = {
  ...
  creative:        { name: 'Form & Function',      cat: 'creative',           color: '#5ba4d4', eyebrow: 'CREATIVE STUDIO',    tagline: 'Design that<br/><em>defines brands</em>',               sub: 'Brand identity, digital design, and creative direction.', cta: 'See Our Work',        img: '1558618666-fcd25c85cd64' },
