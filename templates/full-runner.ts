...
function buildRetailTemplate(data: TemplateData): string {
  ...
  const heroSection = `
  <section style="position:relative;min-height:100vh;padding-bottom:68px;display:grid;grid-template-columns:1fr 1fr;background:${bg}">
...
<section class="hw-hero-section" style="min-height:100vh;display:grid;grid-template-columns:1fr 1fr;background:${hw.bg};position:relative;padding-bottom:48px">
...
${buildStandardNav(businessName, content, navFlags)}
  ...
  <section style="position:relative;min-height:100vh;padding-bottom:70px;display:flex;align-items:center;overflow:hidden;background:${bg};z-index:1">
...
function buildCreativeTemplate(data: TemplateData): string {
  ...
  const heroSection = `
  <section style="background:${ink};min-height:100vh;padding-bottom:58px;display:grid;grid-template-columns:1fr 1fr;overflow:hidden;position:relative" class="ms-grid">
